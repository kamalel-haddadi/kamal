...
function defaultimg() {
    return (
        <svg
            ...
            fill="none"
        >
            <rect width="1200" height="1200" fill="#EAEAEA" rx="3"></rect>
            <g opacity="0.5">
                <g opacity="0.5">
                    <path
                        fill="#FAFAFA"
            ...
            <defs>
                ...
                >
                    <stop stopColor="#C9C9C9" stopOpacity="0"></stop>
                    <stop offset="0.208" stopColor="#C9C9C9"></stop>
                    <stop offset="0.792" stopColor="#C9C9C9"></stop>
